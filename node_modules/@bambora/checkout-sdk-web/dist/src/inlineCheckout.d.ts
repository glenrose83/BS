import { InlineCheckoutInstanceOptions } from "./options";
...
export default class InlineCheckout extends AbstractIframeCheckout<InlineCheckoutInstanceOptions> {
    constructor(sessionToken: string | null, options?: Partial<InlineCheckoutInstanceOptions>);
    /** Mounts the iframe to the specified container. */
    mount(container: Element): Promise<HTMLIFrameElement>;
}
