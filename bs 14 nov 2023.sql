...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 14, 2023 at 11:37 AM
...
CREATE TABLE IF NOT EXISTS `customers` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_danish_ci;
...
(15, 'Malene Rose', 'Egtvedvej', 2, '', 3650, 'Ølstykke', 'Denmark', 31215529, 'Mmmlene@hotmail.com', NULL),
(16, 'Din mor', 'morvej ', 3, 'sal', 2400, 'Kbh', 'Tyskland', 12451245, 'dinmo2@mor.dk', NULL),
(17, 'george', 'Geo', 1, 'suite10', 2400, 'kbh', 'DK', 123457896, 'adsfdf@fdwsf.com', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_danish_ci;
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `delivery_method` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_danish_ci NOT NULL,
  `status` tinytext CHARACTER SET utf8mb3 COLLATE utf8mb3_danish_ci,
  `date_completed` timestamp NULL DEFAULT NULL,
  `total_price` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `customers` (`fk_customer`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_danish_ci;
...
(11, 3, 'img_0170.jpg.jpeg', 'img/img_0170.jpg.jpeg', 0),
(12, 4, 'alimentarium_kiwis_0.jpg', 'img/alimentarium_kiwis_0.jpg', NULL),
(13, 4, 'kiwi-1296x728-header.jpg', 'img/kiwi-1296x728-header.jpg', NULL),
(14, 4, 'Kiwi.jpeg', 'img/Kiwi.jpeg', NULL),
(22, 55, '370373889_228947550143688_4545862118780280373_n.jpg', 'img/370373889_228947550143688_4545862118780280373_n.jpg', NULL),
...
(29, 2, '370373889_228947550143688_4545862118780280373_n.jpg', 'img/370373889_228947550143688_4545862118780280373_n.jpg', 1),
...
ALTER TABLE `ordered_products`
  ...
  ADD CONSTRAINT `products` FOREIGN KEY (`fk_products`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
